export default function Footer() {
  return (
    <>
      <footer className="w-full bg-gradient-to-r from-green/40 to-primary/40 dark:bg-gray-900 py-16 rounded-t-lg">
        <div className="md:px-12 lg:px-28">
          ...
          <a
                ...
                >
                  <div aria-hidden="true" className="flex mx-auto space-x-1">
                    <div className="h-6 w-6 rounded-full bg-primary dark:bg-gray-200"></div>
                    <div className="h-9 w-4 bg-green dark:bg-primaryLight"></div>
                  </div>
                </a>
            <ul
              role="list"
