            ...
            <form>
              <div className="grid gap-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <label for="remember-me" className="text-sm dark:text-white">I accept the <a className="text-blue-600 decoration-2 hover:underline font-medium" href="#">Terms and Conditions</a></label>
                  </div>
                </div>
